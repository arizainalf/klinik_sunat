...
session_start();
include '../../koneksi.php';
// Pastikan file functions.php ada untuk formatRupiah
if (file_exists('../../functions.php')) {
    include '../../functions.php';
} else {
    // Fallback jika file functions tidak ada
...
<head>
    ...
    <title>Data Paket | Sistem Informasi Klinik</title>
    ...
    /* Sidebar & Layout Styles (Sama seperti Data Obat) */
    #wrapper {
        display: flex;
        width: 100%;
        align-items: stretch;
...
<body>
        ...
        <div class="border-end" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush mt-3">
                ...
                <div class="collapse show bg-dark" id="submenuMaster">
                    ...
                    <a href="paket.php"
                        class="list-group-item list-group-item-action bg-primary text-white ps-5 small">Data Paket</a>
                    <a href="../data-tindakan/tindakan.php"
                        class="list-group-item list-group-item-action bg-dark text-white ps-5 small">Data
                        Tindakan</a>
                </div>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 px-4 shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="ms-3 mb-0 d-none d-md-block">Data Paket Layanan</h5>
                </div>
            </nav>
            ...
            <div class="container-fluid px-4 mt-4">
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-box-open me-2"></i>Daftar Paket
                            Sunat</h6>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="dataTable" width="100%">
                                ...
                                <tbody>
                                    <?php 
                                    $nomor = 1;
                                    $ambil = $koneksi->query("SELECT * FROM tb_paket ORDER BY id_paket DESC");
                                    while ($pecah = $ambil->fetch_assoc()) {
                                    ?>
                                    <tr>
                                        <td class="text-center"><?= $nomor++; ?></td>
                                        <td class="fw-bold"><?= $pecah['nm_paket']; ?></td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-danger btn-sm btn-hapus"
                                                data-id="<?= $pecah['id_paket']; ?>"
                                                data-nama="<?= $pecah['nm_paket']; ?>">
                ...
                <form id="formTambah">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nm_paket" class="form-control" required
                                placeholder="Contoh: Paket Laser Premium">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Kosongkan jika harga tetap (fixed).</small>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <p class="text-muted">Apakah Anda yakin ingin menghapus paket <strong id="namaPaket"></strong>?</p>
    ...
    $('#formTambah').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'paket_tambah.php', // Mengarah ke file backend terpisah
            data: $(this).serialize(),
