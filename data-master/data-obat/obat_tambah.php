...
// 1. LOGIKA PENYIMPANAN DATA (Proses di Atas)
if (isset($_POST['save'])) {
    ...
    // Validasi sederhana
    if (empty($jenis_obat)) {
        echo "<script>alert('Harap pilih jenis obat!');</script>";
    } else {
        // Menggunakan Prepared Statement (Aman dari SQL Injection)
        $stmt = $koneksi->prepare("INSERT INTO tb_obat (kd_obat, nm_obat, jenis_obat, stok, harga_obat, exp_obat) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssiis", $kd_obat, $nm_obat, $jenis_obat, $stok, $harga_obat, $exp_obat);
...
// 2. MENGAMBIL KODE TERAKHIR (Untuk Referensi User)
$query_last = mysqli_query($koneksi, "SELECT kd_obat FROM tb_obat ORDER BY id_obat DESC LIMIT 1");
$data_last = mysqli_fetch_assoc($query_last);
$last_code = $data_last ? $data_last['kd_obat'] : "Belum ada data";
?>
...
<head>
    ...
    <title>Tambah Obat | Sistem Informasi Klinik</title>
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 px-4 shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="ms-3 mb-0 d-none d-md-block">Tambah Data Obat</h5>
                </div>
            ...
            <div class="container-fluid px-4 mt-4">
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    <div class="card-header bg-white py-3">
                        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-plus-circle me-2"></i>Form Obat
                            Baru</h6>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="alert alert-info d-flex align-items-center shadow-sm" role="alert">
                            ...
                            <div>
                                <strong>Info:</strong> Kode obat terakhir di sistem:
                                <span class="badge bg-info text-dark ms-1 fs-6"><?= $last_code; ?></span>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">Pastikan kode unik (belum pernah dipakai).</div>
                                    </div>
